    ...
    <table style="width: 100%;">
      <tr>
        ...
        <table style="width: 100%;" >
            ...
            <tr>
                <td class="noline" style="text-align: center;" colspan="2">Dinyatakan telah teregistrasi di Bagian Administrasi Pembangunan dan Perencanaan Kabupaten Tanah Datar</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="noline">
                    <img style="width: 200px;height: 200px;" src="image/cover_login.jpg" alt="" srcset="">
                </td>
